...
const Works = () => {
  return (
    <>
      <div className="h-max w-full pt-48 pb-20 px-20  bg-[#2F4454] flex flex-col items-center" id="Works">
        <h1 className="text-[#60fcff] font-semibold text-[36px] text-center Font fJ">
          My Portfolio
        </h1>
        <p className="text-center mt-2 text-[14px] text-[white] Font font-medium fJ">
      ...
      <div className="h-max w-full bg-[#2F4454] p-20 exp-main">
        <h1 className="text-[#60fcff] font-semibold text-[36px] Font">
          My Experience
        </h1>
        <div className="h-max w-full flex justify-between mt-5 experience">
          <div className="p-10 flex w-[50%] gap-10 exp-1">
            <div className="text-[17px] fJ text-white w-[25%]">
              May 2022 - Present
            </div>
            <div className=" border-l-2 w-[70%]">
              <h1 className="text-[19px] fJ text-white font-medium ml-8">
                WebDevrs
              </h1>
              <h1 className="text-[17px] fJ text-white font-medium ml-8 mt-2">
                Frontend Developer
              </h1>
              <p className="ml-8 mt-5 fJ text-[17px] text-white">
                Crafting responsive web designs using HTML, CSS, and JavaScript
                to ensure intuitive and user-friendly interfaces. Utilizing
                React.js to develop dynamic frontend components and
          ...
          <div className="p-10 w-[50%] flex gap-10 exp-2">
            ...
            <div className=" border-l-2 w-[70%]">
              ...
              <p className="ml-8 mt-5 text-[17px] fJ text-white">
